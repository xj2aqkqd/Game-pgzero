...
# Metallplattformen
metalplatforms = [
    # Bodenplattformen mit Lücken
    Actor("metalplatform.png", anchor=("center", "bottom")),
    Actor("metalplatform.png", anchor=("center", "bottom")),
    Actor("metalplatform.png", anchor=("center", "bottom")),
    Actor("metalplatform.png", anchor=("center", "bottom")),
    # Höhere Sprungplattformen über den Lücken
    Actor("metalplatform.png", anchor=("center", "bottom")),
    Actor("metalplatform.png", anchor=("center", "bottom")),
    Actor("metalplatform.png", anchor=("center", "bottom"))
]
# Bodenstücke
metalplatforms[0].midbottom = (150, HEIGHT)
metalplatforms[1].midbottom = (330, HEIGHT)
metalplatforms[2].midbottom = (630, HEIGHT)
metalplatforms[3].midbottom = (850, HEIGHT)
# Plattformen über den Lücken
metalplatforms[4].midbottom = (520, HEIGHT - 180)
metalplatforms[5].midbottom = (730, HEIGHT - 260)
metalplatforms[6].midbottom = (940, HEIGHT - 160)

# Bodenslime
slime = Actor("slimeblue_blue.png", anchor=("center", "bottom"))
slime.midbottom = (WIDTH - 120, HEIGHT)
...
def draw():
    ...
    # Zeichne Plattformen, Bodenslime und Charakter mit Kamera-Offset
    ...
    slime_screen_x = slime.x - camera_x
    if -100 < slime_screen_x < WIDTH + 100:
        screen.blit(slime.image, (slime_screen_x - slime.width // 2, slime.y - slime.height))
...
def update():
    ...
    # Kollision mit dem Slime prüfen
    if charakter.colliderect(slime):
        game_over = True
